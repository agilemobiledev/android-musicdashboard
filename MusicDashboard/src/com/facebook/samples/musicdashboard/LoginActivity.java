...
public class LoginActivity extends FragmentActivity {
	...
	@Override
	public void onCreate(Bundle savedInstacnce) {
		super.onCreate(savedInstacnce);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        // Call the fragment onActivityResult handler 
        LoginFragment loginFragment = (LoginFragment) getSupportFragmentManager().findFragmentById(R.id.login);
        loginFragment.onLoginResult(requestCode, resultCode, data);
    }
}
